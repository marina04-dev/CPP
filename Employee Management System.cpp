...
int main() {
    ...
    cout<<"\n\t\tEnter new password: ";
    cin>>password;
    cout<<"\t\tYour new id is being created... Please Wait!<<endl;
    
    for (int i=0; i<6; i++) {
      cout<<".";
      Sleep(500);
    }
    cout<<"\t\tYour id created successfully!";
    Sleep(2000);
    start:
    system("CLS");
    string usrn, pswd;
  ...
  if (total != 0) {
    ...
    for (int i=0; i<total; i++) {
      if (e[i].id == id) {
        ...
        cout<<"Contact: "<<e[i].contact<<endl;
        cout<<"Salary: "<<e[i].salary<<endl;
        cout<<"\nEnter new data of employee "<<i+1<<endl<<endl;
        cout<<"Enter employee name: ";
        cin>>e[i].name;
        cout<<"Enter id: ";
        cin>>e[i].id;
...
void del() {
  if (total != 0) {
    int press;
    cout<<"Press 1 to delete specific record or press 2 to delete full record: "<<endl;
    cin>>press;
    if (press == 1) {
      string id;
